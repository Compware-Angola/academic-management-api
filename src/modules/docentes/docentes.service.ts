...
async findAssiduidadeDocente(docenteId: number, filters: FindAssiduidadeDTO) {
  const { gradeId, estadoAgendamento, dataInicio, dataFim, anoLectivo =0, semestre =0, page = 1, limit = 20 } = filters;
  const offset = (page - 1) * limit;
...
const filterParams = {
  d1: docenteId || 0, d2: docenteId || 0,
  g1: gradeId || 0, g2: gradeId || 0,
  e1: estadoAgendamento || 0, e2: estadoAgendamento || 0,
  a1: anoLectivo || 0, a2: anoLectivo || 0,
  s1: semestre || 0, s2: semestre || 0,
