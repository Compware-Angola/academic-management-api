...
export class FindNoteLaunchStudentsDto {
  ...
  @ApiProperty({ example: 22, description: 'Codigo do curso' })
  @Type(() => Number)
  @IsInt()
  @IsPositive()
  courseId: number;
  ...
  @ApiProperty({ example: 224982, description: 'Codigo do horario' })
  @Type(() => Number)
  @IsInt()
  @IsPositive()
  scheduleId: number;

  @ApiProperty({ example: 1, description: 'Codigo do tipo de prova' })
  @Type(() => Number)
  @IsInt()
  @IsPositive()
  examTypeId: number;

  @ApiProperty({ example: 2, description: 'Codigo do tipo de avaliacao' })
  @Type(() => Number)
  @IsInt()
  @IsPositive()
