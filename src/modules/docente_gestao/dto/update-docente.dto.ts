...
export class UpdateDocenteDto {
  @ApiPropertyOptional({ description: 'Apreciação do docente', example: 'Bom desempenho académico' })
  @IsOptional()
  @IsString()
  apreciacao?: string;
  ...
  @ApiPropertyOptional({ description: 'Faculdade associada ao docente', example: 3 })
  @IsOptional()
  @IsNumber()
  faculdade?: number;

  @ApiPropertyOptional({ description: 'Código de validação', example: 'VAL-2024-001' })
  @IsOptional()
  @IsString()
  codigoValidacao?: string;

  @ApiPropertyOptional({ description: 'Valor da hora de trabalho', example: 5000 })
  @IsOptional()
  @IsNumber()
  valorHora?: number;
  ...
  @ApiPropertyOptional({ description: 'Data de início da docência', example: '2023-01-10' })
  @IsOptional()
  @IsDate()
  @Type(() => Date)
  dataInicioDocencia?: Date;

  @ApiPropertyOptional({ description: 'Proposta de contratação', example: 'Contrato anual renovável' })
  @IsOptional()
  @IsString()
  propostaDeContratacao?: string;

  @ApiPropertyOptional({ description: 'Valor da hora alternativo', example: 4500 })
  @IsOptional()
  @IsNumber()
  valorhoraAlt?: number;
